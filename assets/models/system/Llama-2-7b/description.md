...
**How to run the model locally** Llama 2 is available for you to run on device; checkout https://github.com/microsoft/Llama-2-Onnx.
...
## **How to run the model locally Llama 2 is available for you to run on device?**
Check out https://github.com/microsoft/Llama-2-Onnx.
